    ...
    <div class="page animate-fade-in dashboard-page">
      ...
      <div class="section recent-transactions">
        ...
        <div class="card card-flat recent-tx-card">
          ${l.length>0?fs(l,{showActions:!1,showDate:!0,accounts:Ct.accounts}):kb()}
        </div>
      </div>
    </div>
